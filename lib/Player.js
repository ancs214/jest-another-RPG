...
class Player extends Character {
  ...
  constructor(name = '') {
    //call parent constructor to inherit parent methods
    super(name);

    //inventory will start with one health potion and another randomly selected potion
...
//ORIGINAL METHODS BEFORE SWITCHING TO ES6
...
// // create new object that inherit prototype methods from Character
